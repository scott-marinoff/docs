...
| --- | --- |
| Frequency per User | Distribution<br />Average<br />Median<br />Percentile (P25,P75,P90,P99)<br />Minimum<br />Maximum |
| Aggregate Property | Sum<br />Average<br />Median<br />[Distinct Count](https://www.loom.com/share/7d0e42f847c24b3c8720d5b6a6bedeb4)<br />Percentile (P25,P75,P90,P99)<br />Minimum<br />Maximum |
| Aggregate Property per User | Average<br />Sum<br />Distribution<br />Median<br />Percentile (P25,P75,P90,P99)<br />Minimum<br />Maximum |
...
| --- | --- | --- | --- | --- | --- |
| Frequency per user | What's the average number of songs played per user? | What is the distribution of my users by the number of songs played? | What's the median number of songs played per user? | How many songs did the 90th percentile user listen to? | How many songs did my least/most active user listen to? |
